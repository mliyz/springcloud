...
public abstract interface EntityRepository {
    ...
    public abstract <T extends Entity, E extends T> List<T> findByExample(E paramE, ExampleSettings<T> paramExampleSettings);

    public abstract <T extends Entity> List<T> findByProperty(Class<T> paramClass, String paramString, Object paramObject);

    public abstract <T extends Entity> List<T> findByProperties(Class<T> paramClass, NamedParameters paramNamedParameters);

    public abstract <T extends Entity> List<T> findInSet(Class<T> paramClass, String paramString, Set<Object> paramValues);

    public abstract <T extends Entity> List<T> findNotInSet(Class<T> paramClass, String paramString, Set<Object> paramValues);
