...
/**
 * @ClassName: RSAUtils
 * @Description 工具类。提供加密，解密，生成密钥对等方法。
...
public class RSAUtils {
    ...
    public static String decryptData(String data,String priKey) {
        return RSAUtils.decryptDataOnJava(data,priKey);
    }
     ...
     * @throws Exception
     */
    public static String encryptedData(String data,String pubKey) throws Exception {
        byte[] tmp = data.getBytes();
        byte[] encodedData = RSAUtils.encryptByPublicKey(tmp, pubKey);
     ...
     * 解密，加密
     */
    public static String decryptAndEncrypteDate(String data,String priKey,String pubKey) throws Exception {
        //设置密码时先解密，后加密
        //解密
        String decryptData = decryptData(data,priKey);
        //加密
        return encryptedData(decryptData,pubKey);
    }
}
