...
/**
 * kafka 生产者 异步发送消息 Package : com.yixin.common.system.util
 *
 ...
 */
public class SpringKafkaProducerAsync {

	private SpringKafkaProducerAsync() {
	}

	private final static String KAFKA_OUTBOUND_PROPERTIS = "META-INF/props/kafka-outbound.properties";
	private final static Logger logger = LoggerFactory.getLogger(SpringKafkaProducerAsync.class);
