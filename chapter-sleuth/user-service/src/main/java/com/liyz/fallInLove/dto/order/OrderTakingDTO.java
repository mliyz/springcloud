...
/**
 *
 * @ClassName: OrderTakingDTO
 * @Description 订单接单入参
 * @author  YixinCapital -- lizhongxin
 * @date  2018年6月7日 下午8:44:38
 *
 */
public class OrderTakingDTO extends BaseDTO
{
     ...
     * 全款支付返佣金额
     */
    private BigDecimal fullPaymentCommission;

    /**
     * 定金支付返佣
     */
    private BigDecimal depositPaymentCommission;
