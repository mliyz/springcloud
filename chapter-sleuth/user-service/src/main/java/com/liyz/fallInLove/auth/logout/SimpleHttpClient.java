 ...
 * under the License.
 */
package com.liyz.fallInLove.auth.logout;
...
public final class SimpleHttpClient implements HttpClient, Serializable, DisposableBean {
    ...
    private static final class MessageSender implements Callable<Boolean> {
        ...
        public Boolean call() throws Exception {
            ...
            try {
                ...
                final String output = "logoutRequest=" + URLEncoder.encode(message, "UTF-8")+"&logoutc=done";
     ...
     *
     */
    private static final class MessageSenderforlog implements Callable<Boolean> {
        ...
        public MessageSenderforlog(final String url, final String message, final int readTimeout,
	...
	@Override
	public boolean sendMessageToLog(String url, String message, boolean async) {
        final Future<Boolean> result = EXECUTOR_SERVICE.submit(new MessageSenderforlog(url, message,
